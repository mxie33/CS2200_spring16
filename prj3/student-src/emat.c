...
double compute_emat() {
   ...
   long int t_hitsnmiss = total_accesses * MEMORY_ACCESS_TIME + tlb_misses * MEMORY_ACCESS_TIME;
   long int t_fault = count_pagefaults * DISK_ACCESS_TIME;
   long int total_time = t_hitsnmiss + t_fault;
